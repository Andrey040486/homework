...
tables_qantity = store[goods['Стол']][0]['quantity'] + store[goods['Стол']][1]['quantity']
print('Стол -', tables_qantity, 'шт, стоимость', tables_cost, 'руб')
...
chair_qantity = store[goods['Стул']][0]['quantity'] + store[goods['Стул']][1]['quantity'] + store[goods['Стул']][2]['quantity']
print('Стул -', chair_qantity, 'шт, стоимость', chair_cost, 'руб')
