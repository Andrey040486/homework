...
df = int(num_color)
if df == 0:
    triangle = figure(100, 100, 3, 0, length=100, color=colors['КРАСНЫЙ'])
    square = figure(400, 100, 4, 0, length=100, color=colors['КРАСНЫЙ'])
    pentagon = figure(100, 400, 5, 0, length=100, color=colors['КРАСНЫЙ'])
    hexagon = figure(400, 400, 6, 0, length=100, color=colors['КРАСНЫЙ'])
